      	...
      	<div class="row">
	        <div class="col-md-offset-2 col-md-8">
	          <div class="section-heading text-center">
	            ...
	            <p>Berikut ini biodata peserta Porkab Malang VII.</p>
	          </div>
	        </div>
	    </div>
		<form action="<?=base_url()?>submit-edit" method="POST">
			<input type="hidden" name="id" value="<?=$participants[0]->id?>">
		  <div class="form-group row">
		    <label for="nama" class="col-sm-2 col-form-label">Nama</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="nama" placeholder="Nama" value="<?=$participants[0]->nama?>">
		    </div>
		  </div>
		  <div class="form-group row">
		    <label for="alamat" class="col-sm-2 col-form-label">Alamat</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="alamat" placeholder="Alamat" value="<?=$participants[0]->alamat?>">
		    </div>
		  </div>
		  <div class="form-group row">
		    <label for="tempatLahir" class="col-sm-2 col-form-label">Tempat Lahir</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="tempat_lahir" placeholder="Tempat, Tanggal Lahir" value="<?=$participants[0]->tempat_lahir?>">
		    </div>
		  </div>
		  <div class="form-group row">
		    <label for="tanggalLahir" class="col-sm-2 col-form-label">Tanggal Lahir</label>
		    <div class="col-sm-10">
		      <input type="date" class="form-control" name="tanggal_lahir" placeholder="Tempat, Tanggal Lahir" value="<?=$participants[0]->tanggal_lahir?>">
		    </div>
		  </div>
		  <div class="form-group row">
		    <label for="email" class="col-sm-2 col-form-label">Email</label>
		    <div class="col-sm-10">
		      <input type="email" class="form-control" name="email" placeholder="Email" value="<?=$participants[0]->email?>">
		    </div>
		  </div>
		  <div class="form-group row">
		    <label for="no_tlp" class="col-sm-2 col-form-label">No Telepon</label>
		    <div class="col-sm-10">
		      <input type="number" class="form-control" name="no_tlp" placeholder="No Telepon" value="<?=$participants[0]->no_tlp?>">
		    </div>
		  </div>
		  <div class="form-group row">
		    <label for="kecamatan" class="col-sm-2 col-form-label">Kecamatan</label>
		    <div class="col-sm-10">
		      	<select name="kecamatan" id="kecamatan" class="form-control"  value="<?=$participants[0]->kecamatan?>">
			...
			<div class="form-group row">
			    <label for="cabor1" class="col-sm-2 col-form-label">Cabang Olahraga</label>
			    <div class="col-sm-10">
	                <select name="cabor" id="cabor" class="form-control" >
						<option value="<?=$participants[0]->cabor_induk.','.($participants[0]->cabor_jenis !== NULL ? $participants[0]->cabor_jenis."," : '').$participants[0]->cabor_kelas.",".($participants[0]->cabor_keterangan !== NULL ? $participants[0]->cabor_keterangan : '')?>" selected=""><?=$participants[0]->cabor_induk." ".($participants[0]->cabor_jenis !== NULL ? $participants[0]->cabor_jenis." " : '').$participants[0]->cabor_kelas." ".($participants[0]->cabor_keterangan !== NULL ? $participants[0]->cabor_keterangan : '')?></option>
			...
			<div class="form-group row">
			    <label for="cabor2" class="col-sm-2 col-form-label">Kelas Kedua</label>
				<div class="col-sm-10" id="">
					<select name="cabor2" id="cabor2" class="form-control" >
						<option value="<?=$participants[0]->cabor_induk.','.($participants[0]->cabor2_jenis !== NULL ? $participants[0]->cabor2_jenis."," : '').$participants[0]->cabor2_kelas.",".($participants[0]->cabor2_keterangan !== NULL ? $participants[0]->cabor2_keterangan : '')?>" selected=""><?=$participants[0]->cabor_induk." ".($participants[0]->cabor2_jenis !== NULL ? $participants[0]->cabor2_jenis." " : '').$participants[0]->cabor2_kelas." ".($participants[0]->cabor2_keterangan !== NULL ? $participants[0]->cabor2_keterangan : '')?></option>
						<optgroup label="Anggar">
							<option value="Anggar,NULL,Degen,NULL">Degen</option>
							<option value="Anggar,NULL,Sabel,NULL">Sabel</option>
							<option value="Anggar,NULL,Floret,NULL">Floret</option>
