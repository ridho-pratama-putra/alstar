		...
		$(document).ready(function() {
			...
			$('#cabor').on('select2:select',function (e) {
				...
				if (typeof selectedGroup != "undefined") {
					...
					// }
					if (selectedGroup == 'Anggar') {
						elementToRender += 
							'<option selected="" disabled="">Pilih kelas lain dari cabang olahraga pertama apabila ada.</option>'+
					...
					}else if (selectedGroup == 'Kick Boxing(Full Contact) Kelas A' || 'Kick Boxing(Full Contact) Kelas B' || 'Kick Boxing(Point Fighting) Kelas A' || 'Kick Boxing(Point Fighting) Kelas B' || 'Kick Boxing(Musical Form) Kelas A' || 'Kick Boxing(Musical Form) Kelas B') {
						elementToRender += 
							'<option selected="" disabled="">Pilih kelas lain dari cabang olahraga pertama apabila ada.</option>'+
					...
					}else if (selectedGroup =='Pencak Silat(Tanding) Putra' || 'Pencak Silat(Seni) Putra') {
						elementToRender +=
							'<option selected="" disabled="">Pilih kelas lain dari cabang olahraga pertama apabila ada.</option>'+
						...
						'</optgroup>';
					}else if (selectedGroup == 'Pencak Silat(Tanding) Putri' || 'Pencak Silat(Seni) Putri') {
						elementToRender +=
							'<option selected="" disabled="">Pilih kelas lain dari cabang olahraga pertama apabila ada.</option>'+
						...
						'</optgroup>';
					}else if (selectedGroup == 'Shorinji Kempo Putra' || 'Shorinji Kempo Campuran') {
						elementToRender +=
							'<option selected="" disabled="">Pilih kelas lain dari cabang olahraga pertama apabila ada.</option>'+
						...
						'</optgroup>';
					}else if (selectedGroup == 'Shorinji Kempo Putri' || 'Shorinji Kempo Campuran') {
						elementToRender +=
							'<option selected="" disabled="">Pilih kelas lain dari cabang olahraga pertama apabila ada.</option>'+
						...
						'<optgroup label="Shorinji Kempo Campuran">'+
							...
							'<option value="Shorinji Kempo,NULL,Campuran,Embu Beregu">Embu Beregu</option>'+
						'</optgroup>';
					}else if (selectedGroup == 'Gulat Grego Putra' || 'Gulat Bebas Putra') {
						elementToRender +=
							'<option selected="" disabled="">Pilih kelas lain dari cabang olahraga pertama apabila ada.</option>'+
						...
						'</optgroup>';
					}else if (selectedGroup == 'Selam KU A Terbuka' || 'Selam KU B' || 'Selam KU C') {
						elementToRender +=
							'<option selected="" disabled="">Pilih kelas lain dari cabang olahraga pertama apabila ada.</option>'+
					...
					}else if (selectedGroup == 'Taekwondo Gyeorugi Prestasi(Yunior Putra)' || 'Taekwondo Gyeorugi Prestasi(Senior Putra)') {
						elementToRender +=
							'<option selected="" disabled="">Pilih kelas lain dari cabang olahraga pertama apabila ada.</option>'+
					...
					}else if (selectedGroup == 'Taekwondo Gyeorugi Prestasi(Yunior Putri)' || 'Taekwondo Gyeorugi Prestasi(Senior Putri)') {
						elementToRender +=
							'<option selected="" disabled="">Pilih kelas lain dari cabang olahraga pertama apabila ada.</option>'+
		  ...
		  <form action="<?=base_url()?>registrasi" method="post" class="form-horizontal" role="form">
			<div class="col-md-offset-2 col-md-8">
			  <div class="form-group">
				...
				<input type="text" name="nama" id="first_name" class="form-control" value="<?=set_value('nama'); ?>" />
			  </div>
			</div>
			...
			<div class="col-md-offset-2 col-md-8">
			  <div class="form-group">
				<label for="ttl" class="required">Tempat,Tanggal Lahir</label>
					<div class="col">
						<input type="text" placeholder="Tempat," name="tempat_lahir" id="tempat" class="form-control" value="<?=set_value('tempat_lahir'); ?>" />
					</div>
					<div class="col">
						<input type="date"  placeholder="Tanggal Lahir" name="tanggal_lahir" id="ttl" class="form-control" value="<?=set_value('tanggal_lahir'); ?>"/>
					</div>
			  </div>
			</div>
			...
			<div class="col-md-offset-2 col-md-8">
				<div class="form-group">
					...
					<input type="number" name="no_tlp" id="no_tlp" class="form-control" value="<?=set_value('no_tlp'); ?>" />
				</div>
			</div>
			...
			<div class="col-md-offset-2 col-md-8">
				<div class="form-group">
					...
					<select name="kecamatan" id="kecamatan" class="form-control" value="<?=set_value('kecamatan'); ?>">
